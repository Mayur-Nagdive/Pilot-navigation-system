...
#you are the pilot and your plane is at the altitude of 3000ft which is safe for landing
#if the plane is above 3000ft and 6000ft atleast allow the pilot to try for landing
...
if a<=3000:
    ...
    print('your are same to land')

    s=float(input('enter the speed of the plane in m/s \n'))
    if s<=800:
      print('Maintain your speed at 800 m/s while landing')
    else:
